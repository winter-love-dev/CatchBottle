...
@TypeConverters(com.season.winter.core.data.repository.converter.RemoteConfigConverters::class)
    ...
    companion object {
        ...
        private fun buildDatabase(context: Context): RemoteConfigDatabase {
            return Room.databaseBuilder(
                ...
                com.season.winter.core.data.repository.constants.DatabaseName_RemoteConfig
            )
