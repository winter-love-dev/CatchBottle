package com.season.winter.ui.dummy
...
import com.season.winter.ui.fragment.home.ShortcutMenuData
import com.season.winter.ui.fragment.home.ShortcutMenuEvent
...
class HomeUIDummyGenerator {
    ...
    val shortcutMenuData = listOf<ShortcutMenuData>(
        ShortcutMenuData(
    ...
    val mainList: List<HomeItem> = listOf(
        HomeItem(type = HomeItemType.SearchBar),
