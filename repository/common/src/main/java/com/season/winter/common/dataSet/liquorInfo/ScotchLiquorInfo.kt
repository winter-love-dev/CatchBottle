...
import com.season.winter.common.dummy.getScotchLiquorIdentify
import com.season.winter.liquor.liquorInfo.LiquorStatus

val theMacllan12ySherryOak = LiquorInfo(
    identify = com.season.winter.common.dummy.getScotchLiquorIdentify(0),
...
val balvenieDoublewood12Yo = LiquorInfo(
    identify = com.season.winter.common.dummy.getScotchLiquorIdentify(1),
    nameKo = "발베니 더블우드 12년",
...
val glenmorangieLasanta12yo = LiquorInfo(
    identify = com.season.winter.common.dummy.getScotchLiquorIdentify(2),
